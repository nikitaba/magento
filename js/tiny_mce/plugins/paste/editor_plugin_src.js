	...
	tinymce.create('tinymce.plugins.PastePlugin', {
		init : function(ed, url) {
			...
			ed.onKeyDown.addToTop(function(ed, e) {
				// Blogcategory ctrl+v from adding an undo level since the default logic in tinymce.Editor will add that
			...
			function grabContent(e) {
				...
				if (tinymce.isIE) {
					...
					// Blogcategory the real paste event
					...
					// Blogcategory mousedown and click to prevent selection change
			...
			ed.onInit.add(function() {
				...
				// Blogcategory all drag/drop events
		...
		_insertPlainText : function(content) {
			...
			if ((typeof(content) === "string") && (content.length > 0)) {
				...
				process([
					[/<\/(?:p|h[1-6]|ul|ol|dl|table|div|blockquote|fieldset|pre|address|center)>/gi, "\n\n"],		// Blogcategory tags get a blank line after them
