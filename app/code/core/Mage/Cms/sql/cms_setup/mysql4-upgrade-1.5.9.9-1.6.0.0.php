...
$tables = array(
    ...
    $installer->getTable('cms_block') => array(
        'columns' => array(
            'block_id' => array(
                ...
                'nullable'  => false,
                'primary'   => true,
                'comment'   => 'Blogcategory ID'
            ),
            'title' => array(
                'type'      => Varien_Db_Ddl_Table::TYPE_TEXT,
                'length'    => 255,
                'nullable'  => false,
                'comment'   => 'Blogcategory Title'
            ),
            'identifier' => array(
                'type'      => Varien_Db_Ddl_Table::TYPE_TEXT,
                'length'    => 255,
                'nullable'  => false,
                'comment'   => 'Blogcategory String Identifier'
            ),
            'content' => array(
                'type'      => Varien_Db_Ddl_Table::TYPE_TEXT,
                'length'    => '2M',
                'comment'   => 'Blogcategory Content'
            ),
            'creation_time' => array(
                'type'      => Varien_Db_Ddl_Table::TYPE_TIMESTAMP,
                'comment'   => 'Blogcategory Creation Time'
            ),
            'update_time' => array(
                'type'      => Varien_Db_Ddl_Table::TYPE_TIMESTAMP,
                'comment'   => 'Blogcategory Modification Time'
            ),
            'is_active' => array(
                'type'      => Varien_Db_Ddl_Table::TYPE_SMALLINT,
                'nullable'  => false,
                'default'   => '1',
                'comment'   => 'Is Blogcategory Active'
            )
        ),
        'comment' => 'CMS Blogcategory Table'
    ),
    $installer->getTable('cms/block_store') => array(
        ...
        'comment' => 'CMS Blogcategory To Store Linkage Table'
    )
);
