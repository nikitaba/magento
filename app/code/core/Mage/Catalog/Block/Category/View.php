...
class Mage_Catalog_Block_Category_View extends Mage_Core_Block_Template
{
    ...
    /**
     * Check if category display mode is "Static Blogcategory and Products"
     * @return bool
     */
    ...
    /**
     * Check if category display mode is "Static Blogcategory Only"
     * For anchor category with applied filter Static Blogcategory Only mode not allowed
     *
     * @return bool
     */
