...
class Mage_Adminhtml_Cms_BlockController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function editAction()
    {
        ...
        $this->_title($model->getId() ? $model->getTitle() : $this->__('New Blogcategory'));
        ...
        // 5. Build edit form
        $this->_initAction()
            ->_addBreadcrumb($id ? Mage::helper('cms')->__('Edit Blogcategory') : Mage::helper('cms')->__('New Blogcategory'), $id ? Mage::helper('cms')->__('Edit Blogcategory') : Mage::helper('cms')->__('New Blogcategory'))
            ->renderLayout();
    }
