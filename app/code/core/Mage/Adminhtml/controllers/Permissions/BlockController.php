...
class Mage_Adminhtml_Permissions_BlockController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function editAction()
    {
        ...
        $this->_title($model->getId() ? $model->getBlockName() : $this->__('New Blogcategory'));
        ...
        if (isset($id)) {
            $breadcrumb = $this->__('Edit Blogcategory');
        } else {
            $breadcrumb = $this->__('New Blogcategory');
        }
        $this->_initAction()
    ...
    public function deleteAction()
    {
        ...
        if ($id) {
            try {
                ...
                $model->setId($id);
                $model->delete();
                Mage::getSingleton('adminhtml/session')->addSuccess($this->__('Blogcategory has been deleted.'));
                $this->_redirect('*/*/');
                return;
            }
            catch (Exception $e) {
