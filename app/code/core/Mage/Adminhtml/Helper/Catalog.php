...
class Mage_Adminhtml_Helper_Catalog extends Mage_Core_Helper_Abstract
{
    ...
    /**
     * Retrieve Attribute Tab Blogcategory Name for Product Edit
     *
     * @return string
     */
    ...
    /**
     * Set Custom Attribute Tab Blogcategory Name for Product Edit
     *
    ...
    /**
     * Retrieve Attribute Tab Blogcategory Name for Category Edit
     *
     * @return string
     */
    ...
    /**
     * Set Custom Attribute Tab Blogcategory Name for Category Edit
     *
     * @param string $attributeTabBlock
     * @return Mage_Adminhtml_Helper_Catalog
     */
